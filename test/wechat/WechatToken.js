    ...
    describe('#getJt()', function(){
        ...
        it("force to get a brand new js ticket, and it should be different from the last one", function(done){
            ...
            wechatToken.getJt(true, function(err, jt){
                ...
                if(newJt==cachedJt){
                    console.info('new jt is equal to cached jt');
                }
                else{
                    console.info('new jt is NOT equal to cached jt');
                }
                console.info('cached jt: ' + cachedJt);
                console.info('new jt: ' + newJt);
                //assert.notEqual(newJt, cachedJt);
                done();
            });
        });
        ...
        it("force to get a brand new js ticket, and it should be different from the last one", function(done){
            ...
            wechatToken.getJt(true, function(err, jt){
                ...
                console.info('cached jt: ' + newJt);
                console.info('new jt: ' + jt.value);

                //assert.notEqual(jt.value, newJt);
                console.info(jt);
                console.info();
                done();
            });
